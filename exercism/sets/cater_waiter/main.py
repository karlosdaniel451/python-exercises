...
def main():
    ...
    print(tag_special_ingredients(('Ginger Glazed Tofu Cutlets',
                                   ['tofu',
                                    'soy sauce',
                                    'ginger',
                                    'corn starch',
                                    ...
                                    'sesame seeds',
                                    'lemon juice'])))
    print(tag_special_ingredients(('Arugula and Roasted Pork Salad',
                                   ['pork tenderloin',
                                    'arugula',
                                    'pears',
                                    'blue cheese',
...
def check_drinks(drink_name: str, drink_ingredients: list[str]) -> str:
    ...
    return drink_name + \
        (' Cocktail' if set(drink_ingredients).intersection(ALCOHOLS) else ' Mocktail')
...
def tag_special_ingredients(dish: tuple) -> tuple:
    ...
    ingredients_to_be_tagged = dish_ingredients_set.intersection(
        SPECIAL_INGREDIENTS)

    return (dish_name, ingredients_to_be_tagged)
...
def compile_ingredients(dishes: list[set[str]]) -> set[str]:
    ...
    for dish in dishes:
        compiled_ingredients.update(dish)
...
def singleton_ingredients(dishes: list[set[str]],
    ...
    for dish in dishes:
        singleton_ingredients_set.update(dish)

    for dish in dishes:
        singleton_ingredients_set.difference_update(
            dish.intersection(intersection))
